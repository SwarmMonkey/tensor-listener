 ...
 * 
 * Dark-themed HTML email template for notifying users when their NFT receives an offer.
 */
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #1a1a1a; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.3);">
          ...
          <tr>
            <td style="padding: 32px 40px;">
              ...
              <p style="margin: 0 0 20px; font-size: 16px; line-height: 1.6; color: #d4d4d4;">
                Someone has made an offer on your card:
              </p>
              ...
              <div style="background-color: #252525; border-radius: 8px; padding: 20px; margin: 20px 0; border: 1px solid #333333;">
                ...
                <p style="margin: 0 0 8px; font-size: 14px; color: #a3a3a3;">
                  Offer: <span style="color: #60a5fa; font-weight: 600; font-size: 18px;">${priceDisplay}</span>
                </p>
                <p style="margin: 0; font-size: 14px; color: #a3a3a3;">
                  Bidder: <span style="color: #e5e5e5; font-family: monospace; font-size: 13px;">${truncatedWallet}</span>
                </p>
              </div>

              <p style="margin: 20px 0; font-size: 16px; line-height: 1.6; color: #d4d4d4;">
                Log in to Graded to review and respond to this offer.
              </p>
