            ...
            <td style="padding: 40px;">
              ...
              <div style="background-color: #252525; border-radius: 8px; padding: 24px; margin: 24px 0; border: 1px solid #333333;">
                ...
                <p style="margin: 0 0 8px; font-size: 14px; color: #a3a3a3;">
                  Offer: <span style="color: #60a5fa; font-weight: 600; font-size: 20px;">${priceDisplay}</span>
                </p>
                <p style="margin: 0; font-size: 14px; color: #a3a3a3;">
                  Bidder: <span style="color: #e5e5e5; font-family: monospace;">${truncatedWallet}</span>
                </p>
              </div>
